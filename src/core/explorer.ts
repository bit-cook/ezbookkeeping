...
export enum TransactionExplorerConditionFieldType {
    ...
    DescriptionIgnoresCase = 'descriptionIgnoresCase'
}
...
export class TransactionExplorerConditionField implements NameValue {
    ...
    public static readonly DescriptionIgnoresCase = new TransactionExplorerConditionField('Description (Ignores Case)', TransactionExplorerConditionFieldType.DescriptionIgnoresCase);
