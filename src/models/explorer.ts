    ...
    public addNewCondition(field: TransactionExplorerConditionField, isFirst: boolean): TransactionExplorerConditionWithRelation {
        ...
        switch (field) {
            ...
            case TransactionExplorerConditionField.Description:
                ...
                break;
            case TransactionExplorerConditionField.DescriptionIgnoresCase:
                condition = new TransactionExplorerDescriptionIgnoresCaseCondition(TransactionExplorerConditionOperatorType.Contains, '');
                break;
            default:
                condition = new TransactionExplorerTransactionTypeCondition(TransactionExplorerConditionOperatorType.In, [ TransactionType.Expense, TransactionType.Income, TransactionType.Transfer ]);
                break;
    ...
    public getSupportedOperators(): TransactionExplorerConditionOperator[] {
        ...
        switch (this.condition.field) {
            ...
            case TransactionExplorerConditionField.Description.value:
                ...
                break;
            case TransactionExplorerConditionField.DescriptionIgnoresCase.value:
                operatorTypes = TransactionExplorerDescriptionIgnoresCaseCondition.supportedOperators;
                break;
            default:
                return [];
        }
        ...
        if (relation === TransactionExplorerConditionRelation.First ||
            ...
            switch (conditionField) {
                ...
                case TransactionExplorerConditionField.Description.value:
                    ...
                    break;
                case TransactionExplorerConditionField.DescriptionIgnoresCase.value:
                    if (TransactionExplorerDescriptionIgnoresCaseCondition.supportedOperators[conditionOperator] && typeof conditionValue === 'string') {
                        condition = new TransactionExplorerDescriptionIgnoresCaseCondition(conditionOperator as DescriptionConditionOperator, conditionValue);
                    }
                    break;
                default:
                    break;
...
type DescriptionConditionField = TransactionExplorerConditionFieldType.Description | TransactionExplorerConditionFieldType.DescriptionIgnoresCase;
...
export abstract class AbstractTransactionExplorerDescriptionCondition<T = DescriptionConditionField> implements TransactionExplorerCondition<T, string> {
    ...
    public value: string;
    protected abstract readonly ignoreCase: boolean;
    ...
    public match(transaction: TransactionInsightDataItem): boolean {
        const description = transaction.comment ? (this.ignoreCase ? transaction.comment.toLowerCase() : transaction.comment) : '';
        const keyword = this.ignoreCase ? this.value.toLowerCase() : this.value;
...
export class TransactionExplorerDescriptionCondition extends AbstractTransactionExplorerDescriptionCondition<TransactionExplorerConditionFieldType.Description> {
    ...
    protected readonly ignoreCase = false;
...
export class TransactionExplorerDescriptionIgnoresCaseCondition extends AbstractTransactionExplorerDescriptionCondition<TransactionExplorerConditionFieldType.DescriptionIgnoresCase> {
    public readonly field = TransactionExplorerConditionFieldType.DescriptionIgnoresCase;
    protected readonly ignoreCase = true;
